...
export default class PatchNotes extends React.PureComponent<PatchNotesProps> {
	...
	render() {
		return (
			...
			>
				<header
					className="quickview-header notification is-success"
					onClick={this.props.onTogglePatchNotes}
				>
					<p className="title">about...</p>
					<span className="delete is-large" data-dismiss="quickview"></span>
				</header>
				<p>... info here... link to sbl here...</p>
				<header
					className="quickview-header notification is-warning"
					onClick={this.props.onTogglePatchNotes}
				>
					<p className="title">patch notes - things have changed...</p>
					<span className="delete is-large" data-dismiss="quickview"></span>
				</header>
				<div className="quickview-body" style={{ padding: "2rem 1rem" }}>
