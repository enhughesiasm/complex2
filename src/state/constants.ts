...
export const maxRarityFactor = 20;

/** how long to show floaty text for
 */
export const textNotificationTime_s = 1.5;

// visual trait display
export const visual_traits_maxAmount = 16;
export const visual_traits_scroll_max_seconds = 0.6; // won't scroll more often that this, to avoid visual overwhelm
